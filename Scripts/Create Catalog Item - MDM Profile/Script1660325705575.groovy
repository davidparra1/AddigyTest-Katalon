...
WebUI.setText(findTestObject('Object Repository/Page_Addigy  Catalog MDM Profiles/input_Payload Name_input'), 1++)
...
WebUI.click(findTestObject('Object Repository/Page_Addigy  Catalog MDM Profiles/span_When including a key, the default key _e80083_1'))
